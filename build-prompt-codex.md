...
Use this template every time you want Codex to add a feature or make a change. Copy the template, fill in the parts in square brackets `[like this]`, and paste it into Codex.
...
Not sure what to build? Try one of these ready-made prompts. Copy and paste the whole block into Codex.
...
**Previous step:** [Codex Setup Prompt](setup-prompt-codex.md) | **Next step:** [Codex Debug Prompt &rarr;](debug-prompt-codex.md)
