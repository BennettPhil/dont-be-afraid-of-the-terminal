...
Use this prompt when you are setting up a new project in Claude Code. Copy the whole template below, fill in the parts in square brackets `[like this]`, and paste it into Claude Code.
...
**Previous step:** [Install Dependencies](install-dependencies.md) | **Next step:** [Claude Code Build Prompt &rarr;](build-prompt-claude.md)
