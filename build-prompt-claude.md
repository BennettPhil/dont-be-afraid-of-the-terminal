[&larr; Back to Build Prompt](build-prompt.md)

# Claude Code Build Prompt

Use this template every time you want Claude Code to add a feature or make a change. Copy the template, fill in the parts in square brackets `[like this]`, and paste it into Claude Code.
...
Not sure what to build? Try one of these ready-made prompts. Copy and paste the whole block into Claude Code.
...
- It should sit in the top menu bar in macOS and in the system tray in Windows
...
**Previous step:** [Claude Code Setup Prompt](setup-prompt-claude.md) | **Next step:** [Claude Code Debug Prompt &rarr;](debug-prompt-claude.md)
